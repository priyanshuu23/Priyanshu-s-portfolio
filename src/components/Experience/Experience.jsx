  ...
  const experienceData = [
    {
      ...
      bullets: [
        "Resolved 50+ production incidents using structured debugging and RCA in live environments",
        "Reduced recurring issues by identifying root causes and implementing long-term fixes",
        "Stabilized ServiceNow production workflows by resolving critical failures impacting live systems",
        "Identified performance bottlenecks and improved system behavior under real production load",
        "Debugged REST APIs and backend workflows affecting enterprise applications",
        "Worked with cross-functional teams under SLA constraints to minimize downtime",
      ],
